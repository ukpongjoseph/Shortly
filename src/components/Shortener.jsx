...
const Shortener = () => {
  return (
    <div className='relative bg-gray-100 pb-20'>
      <div className='relative top-[-75px] md:top-[-70px] z-10'>
        <Advanced/>
      </div>
    <div className='relative'>
      <div className='flex flex-col  w-[95%] md:w-[85vw] lg:w-[80vw] mx-auto container'>
        ...
        <div className='md:pb-20'>
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-12 md:gap-5 md:justify-around px-5 md:px-0">
            <div className="absolute w-2 md:w-[80%] h-[80%] md:h-2 bg-[hsl(180,66%,49%)] top-[10%] md:top-[50%] md:left-[10%]"></div>
            <div className='z-10 bg-white rounded-md px-5 relative flex h-[250px] flex-col justify-center items-center md:items-start'>
              <div className='w-18 h-18 rounded-full bg-[hsl(257,27%,26%)] flex justify-center items-center absolute bottom-[85%]'>
                <img src={brand} alt="" />
              </div>
              <h1 className='font-bold text-[hsl(260,8%,14%)] text-xl md:text-sm lg:text-2xl'>Brand Recognition</h1>
            ...
            <div className='z-10 mt-0 md:mt-12 bg-white rounded-md px-5 relative h-[250px] flex flex-col justify-center items-center md:items-start'>
              <div className='w-18 h-18 rounded-full bg-[hsl(257,27%,26%)] flex justify-center items-center absolute bottom-[85%]'>
                <img src={detailed} alt="" />
              </div>
              <h1 className='font-bold text-[hsl(260,8%,14%)] text-xl md:text-sm lg:text-2xl'>Detailed Records</h1>
            ...
            <div className='z-10 mt-0 md:mt-24 bg-white rounded-md px-5 relative flex h-[250px] flex-col justify-center items-center md:items-start'>
              <div className='w-18 h-18 rounded-full bg-[hsl(257,27%,26%)] flex justify-center items-center absolute bottom-[85%]'>
                <img src={customizable} alt="" />
              </div>
              <h1 className='font-bold text-[hsl(260,8%,14%)] text-xl md:text-sm lg:text-2xl md:pt-10 lg:pt-0'>Fully Customizable</h1>
