        ...
        <div>
          <div className='w-[100%] flex flex-col md:flex-row'>
            ...
            <div className='bg-white rounded-md px-5 py-10 relative h-[250px] flex flex-col justify-center items-center md:items-start'>
              ...
              <h1 className='md:border-b-6 border-t-0 border-l-0 md:border-r-0 border-r-6 border-b-0 w-[50%] md:w-auto border-[hsl(180,66%,49%)] text-gray-100 h-[125px]'>hello</h1>
            {/* second box */}
