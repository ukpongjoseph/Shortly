      ...
      <div className='flex-1 py-5 md:py-8 lg:py-6 flex justify-center md:w-[80vw] mx-auto md:static'>
          <div className='w-[95%] md:w-[92vw] lg:w-[90vw] container flex flex-col items-end justify-end gap-3 md:flex-row-reverse pt-4'>
              ...
              <div className='text-center md:text-start flex flex-col gap-4 md:w-[50%] md:my-auto'>
                  ...
                  <button className='rounded-full bg-[hsl(180,66%,49%)] text-white px-3 py-1 hover:cursor-pointer hover:bg-[hsla(180,66%,49%,0.5)] font-semibold text-md md:text-lg lg:text-xl lg:w-[30%] w-[40%] mx-auto md:mx-0'>Get Started</button>
              </div>
          </div>
      </div>
      <div className='flex flex-1 absolute top-[88%] left-[3%] w-[94%]'>
        <Advanced/>
      </div>
    </div>
  )
